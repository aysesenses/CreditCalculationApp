...
import com.aysesenses.creditcalculationapp.databinding.ItemTransportBinding

class TransportAdapter (private val onClickListener: OnClickListener) : ListAdapter<BankProperty, TransportAdapter.BankPropertyViewHolder>(DiffCallback) {

    class BankPropertyViewHolder(private var binding: ItemTransportBinding):
